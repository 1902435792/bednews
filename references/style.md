...
### 1. 绝对禁止情感泄露 (Exclamatory Emotional Leaks Banned)
*   **严禁感叹号**：全文感叹号使用率必须为 **0%**。感叹号代表无能的宣泄，而冷静的算账才具有毁灭性的说服力。
*   **严禁无病呻吟的煽情与道德绑架**：拒绝“众所周知”、“不言而喻”、“毋庸置疑”等假设读者已知、带有强加性质的陈词滥调。

### 2. 摒弃模糊代理，实行“实名制质问” (No Ambiguous Agents)
*   **禁用模糊主体**：禁止使用“有消息称”、“大家认为”、“某些部门”、“相关单位”等面目模糊的懒政表达。
*   **必须精准点名**：必须精确指明行政主体或经济实体的全称（例如：“北京市人力资源与社会保障局印发的文件”、“某地级市住建局的行政处罚决定书”、“某家私营微型企业的纳税避险博弈”）。将问题还原为具体行政机关的 KPI 冲突或具体法人的合规边界。

| ❌ 模糊感性表达（禁止） | ✅ 临床理性陈述（强制） |
| :--- | :--- |
| 大学生就业形势非常严峻，大家都很焦虑。 | 2026届 1270 万毕业生面临着供给洪峰，而期望进入私营企业的比例则腰斩至 12.5%。 |
| 某些地方政府为了面子工程，债台高筑。 | 该地级市通过设立投融资平台，在公共预算收入仅有 12 亿的背景下，撬动了 150 亿的城投信贷。 |
| 这种政策简直是荒谬透顶，完全不考虑老百姓！ | 这一技术性合规红线，客观上变成了谁先积极找工作、谁就先被制度淘汰的惩罚机制。 |

### 3. 脱去学理外衣：反学术黑话与“双引号”泛滥 (Anti-Academic Jargon & Quotes)
*   **禁止在口播中直接堆砌学术黑话**：像“二阶自反性”、“行政套利”、“制度性悬空”、“逆向惩罚博弈”这类学理词汇，仅允许在**设计蓝图阶段**作为分析与支撑工具；在**最终口播文稿**中，必须用大白话大方地还原出来。口播不能有任何高高在上的学术门槛。
    *   *学理黑话（禁止）*：“这是一种制度性悬空与行政套利博弈。”
    *   *大白话还原（强制）*：“说白了，就是年轻人宁可在家悬着不签合同，也要拿稳这张应届生的入场券。”
    *   *学理黑话（禁止）*：“行政信用在基层传导发生阻尼和破裂。”
    *   *大白话还原（强制）*：“上级的红头文件到了底下，直接被办事员的自我保护给挡了回去。”
*   **严禁滥用双引号和特殊括号**：双引号 `""`/`“”` 或特殊符号 `「」` 在口播中是听不见的。过多使用双引号，会使文稿变成充满概念暗示的学术论文，削弱叙事的流畅性。
    *   严禁将普通的、常用的网络热词或社会词汇用双引号包裹（如：躺平、慢就业、出厂、保质期、新手外挂等，**一律去掉双引号直接书写**）。
    *   双引号仅限于：法律法规/官方文件的**原文引用**，或者极其罕见的特定专有名词。普通表达必须自然流露，绝不带引号。
...
### 1. 概念重新定义 (Redefine)
不要沿用主流媒体的定义，要用具有强烈物质、事实属性的白话概念来抢夺定义权。
*   *不要说*“员工被骗贷”，要定义为**员工没拿到工资反被套上贷款的荒谬事实**。
*   *不要说*“大学生就业难”，要定义为**过剩的高等教育产能与低端服务业的不兼容**。
*   *不要说*“灵活就业”，要定义为**毕业生为了保住身份宁可断缴社保在社会上空转的避险博弈**。
...
文稿的结构必须呈现出**两轮自我反思（Second-Order Self-Reflection）的递进节奏**，在口播的段落过渡中实现“剥洋葱式”深挖。
...
## 六、 禁用词汇与防雷指南 (Banned Words)

为了确保文风的绝对严肃，凡是带有感情色彩的修饰词和主观预设，一律排除：
*   ❌ 绝对禁用：**“众所周知”、“不言而喻”、“毋庸置疑”、“显而易见”、“不得不说”、“令人唏嘘”**。
*   ❌ 禁用情绪发泄：**“奇葩”、“可恶”、“悲哀”、“无耻”**。全部用冷峻的制度免责博弈来解释。
*   ❌ 禁用无出处数据：禁止在没有说明官方年鉴、审计公告、财报或权威调研等数据源的情况下，抛出孤立数字。每一个核心数字，都必须有明确的“事实防护罩”背书。
